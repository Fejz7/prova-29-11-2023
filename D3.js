...
for (let i = 0; i < starWarsCharacters.length; i++) {
    const nomi = starWarsCharacters[i].name
    charactersNames.push(nomi)
  }
...
// case "blue": (starWarsCharacters[i].name) break
// case "yellow": (starWarsCharacters[i].name) break
// case "brown": (starWarsCharacters[i].name) break
// case "red": (starWarsCharacters[i].name) break
// case "blue-gray": (starWarsCharacters[i].name) break
// default "blue": (starWarsCharacters[i].name)
// }
/* ESERCIZIO 6
